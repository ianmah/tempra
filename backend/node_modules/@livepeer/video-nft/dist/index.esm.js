...
class VideoNFT {
    ...
    mintNft(tokenUri, contractAddress, to) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const videoNft = new ethers.Contract(contractAddress, videoNftAbi, signer);
...
export { VideoNFT, addChain, getBuiltinChain, isChainBuiltin, listBuiltinChains, switchChain, switchOrAddChain, toHexChainId, toNumberChainId };
