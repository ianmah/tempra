 ...
 * and run json-schema-to-typescript to regenerate this file.
 */
export declare type CdnDataPayload = {
    region: string;
    file_name: string;
    date: number;
...
export interface Webhook {
     ...
     */
    event?: 'stream.started' | 'stream.detection' | 'stream.idle' | 'recording.ready' | 'recording.started' | 'recording.waiting' | 'multistream.connected' | 'multistream.error' | 'multistream.disconnected';
    events?: ('stream.started' | 'stream.detection' | 'stream.idle' | 'recording.ready' | 'recording.started' | 'recording.waiting' | 'multistream.connected' | 'multistream.error' | 'multistream.disconnected')[];
    url: string;
    deleted?: boolean;
    /**
...
export interface Stream {
    ...
    presets?: ('P720p60fps16x9' | 'P720p30fps16x9' | 'P720p30fps4x3' | 'P576p30fps16x9' | 'P360p30fps16x9' | 'P360p30fps4x3' | 'P240p30fps16x9' | 'P240p30fps4x3' | 'P144p30fps16x9')[];
    /**
...
export interface Task {
    ...
    status?: {
         ...
         * Phase of the task
         */
        phase?: 'pending' | 'waiting' | 'running' | 'failed' | 'completed' | 'cancelled';
        /**
 ...
 * Parameters for the export task
 */
export declare type ExportTaskParams = {
    /**
     * custom URL parameters for the export task
     */
    custom: {
